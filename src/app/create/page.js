...
export default function Home() 
{
  ...
  function handleNext()
  {
    router.push(`/create/generate/${encodeURIComponent(topic)}?count=${Number(questionCount)}&level=${level}&explanations=${includeExplanations}`)
  }
  ...
  return (
    <div className="p-2 sm:p-12 bg-gray-900 min-h-screen flex flex-col items-center">
      <div className="w-full max-w-4xl mx-auto rounded-t-lg bg-gray-800 px-6 py-4 flex justify-between items-center shadow-lg mb-1">
        <h2 className="text-white text-3xl text-center w-full font-bold tracking-wide">Create Quiz</h2>
      </div>

      <div className="w-full max-w-4xl mx-auto p-4 sm:p-4 bg-gray-800 shadow-xl flex flex-col gap-4 sm:gap-6">
      ...
      <div className="w-full max-w-4xl mx-auto p-4 bg-gray-800 mt-1 rounded-b-lg shadow-xl flex flex-col gap-4">
